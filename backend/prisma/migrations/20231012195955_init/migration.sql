...
CREATE TABLE "users" (
    ...
    "jwtAccess" TEXT DEFAULT '',
    "prefferedTableSide" INTEGER NOT NULL DEFAULT 3,
    "pongColorScheme" INTEGER NOT NULL DEFAULT 1,
...
-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_cid_fkey" FOREIGN KEY ("cid") REFERENCES "Channel"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

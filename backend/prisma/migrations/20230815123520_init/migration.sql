...
CREATE TABLE "Game" (
    "id" INTEGER NOT NULL,
    "playerLeft" INTEGER NOT NULL,
    "playerRight" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "_UserBlocking" ADD CONSTRAINT "_UserBlocking_A_fkey" FOREIGN KEY ("A") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_UserBlocking" ADD CONSTRAINT "_UserBlocking_B_fkey" FOREIGN KEY ("B") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

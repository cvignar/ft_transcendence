...
export class Controls extends ControlOptions {
    constructor(socket, image) {
        super();
        this.msg = new BrowserMsg;
        this.interval = 0;
        this.lastCmd = GameCmd.NOCMD;
        ...
        this.image = image;
        // Mouse controls
        this.image.canvas.addEventListener('mousemove', (mouse) => {
